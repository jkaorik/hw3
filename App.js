...
//Adjusted the code so that the display changes based on the movie input
...
/////// Store the first result in state using the name `movie`
    ...
    return (
      <View style={styles.container}>
        ...
        <TextInput style={styles.movieNameInput}
                  ...
                  /// Change text based on what users entered as a movie title
